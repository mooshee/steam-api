...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	[[NSUserDefaults standardUserDefaults] setDefaultParameterValue:[SteamAPIClient sharedClient].webAPIKey forKey:@"key"];
	[[NSUserDefaults standardUserDefaults] setDefaultParameterValue:@"76561198046922322" forKey:@"steamid"];
